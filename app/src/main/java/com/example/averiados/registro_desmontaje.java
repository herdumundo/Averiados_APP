...
public class registro_desmontaje extends AppCompatActivity {
    ...
    public void registrar_devolucion(View view) {
        ...
        client.post("http://192.168.6.162/ws/control_insert.aspx", params, new TextHttpResponseHandler() {
                    @Override
                    public void onStart() {
    ...
    private void cargar_grilla() {
        ...
        RequestParams params = new RequestParams();
        params.put("txtdeposito", datos_usuario.tipo_registro);
        client.post("http://192.168.6.162/ws/control_select.aspx", params, new TextHttpResponseHandler() {
                    @Override
                    public void onStart() {
