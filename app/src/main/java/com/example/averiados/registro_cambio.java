...
public class registro_cambio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_spinner_huevo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        lv_cambio.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
    ...
    private void buscar_lotes_ws() {
        ...
        client.post("http://" + Utilidades.IP + "/ws/control_select_lotes.aspx", params, new TextHttpResponseHandler() {
                    @Override
                    public void onStart() {
                ...
                .setPositiveButton("SI", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (destino.length() == 0) {
                            ...
                            String url = "http://" + Utilidades.IP + "/ws/control_tr_devoluciones.aspx";
