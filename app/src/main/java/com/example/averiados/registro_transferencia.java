...
public class registro_transferencia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_fecha_trans.setFocusable(false);
        txt_fecha_trans.setFocusableInTouchMode(false);
        ...
        txt_spinner_tipo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        txt_spinner_destino.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        txt_fecha_trans.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void registrar() {
        ...
        client.post("http://" + Utilidades.IP + "/ws/Test/control_transferencias.aspx", params, new TextHttpResponseHandler() {
