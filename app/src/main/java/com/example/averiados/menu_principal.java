...
public class menu_principal extends AppCompatActivity {
    ...
    /*
        public void sincronizar_clientes(View view) {
            ...
            client.post("http://" + Utilidades.IP + "/ws/control_select_clientes.aspx", params, new TextHttpResponseHandler() {
                        @Override
                        public void onStart() {
                        ...
                        public void onFailure(int statusCode, Header[] headers, String res, Throwable t) {
                            ...
                            new AlertDialog.Builder(menu_principal.this)
                                    .setTitle("ATENCION!!!")
                                    .setMessage("ERROR DE CONEXION, FAVOR INTENTE DE NUEVO." + t.toString())
    ...
    */
    public void sincronizar_clientes(View view) {
        ...
        String endpoint = "control_select_clientes.aspx";
        String url = volleyManager.getBaseUrl() + endpoint;
        progress = ProgressDialog.show(menu_principal.this, "PREPARANDO SINCRONIZACION", "ESPERE...", true);
        StringRequest strRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        new AlertDialog.Builder(menu_principal.this)
                                .setTitle("ATENCION!!!")
                                .setMessage("ERROR DE CONEXION, FAVOR INTENTE DE NUEVO." + error.toString())
                                .setNegativeButton("CERRAR", null).show();
                    }
                }) {
        };
    ...
    private void showProgressDialog() {
        ...
        prodialog.setCanceledOnTouchOutside(false);
        prodialog.setCancelable(false);
        new hilo_importar_cliente().start();
    }
    ...
    private void calcular_depositos() {
        ...
        client.post("http://" + Utilidades.IP + "/ws/control_select_depositos.aspx", params, new TextHttpResponseHandler() {
                    @Override
                    public void onStart() {
